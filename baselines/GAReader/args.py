...
def get_args(data_dir, cache_dir, embedding_folder, model_dir, log_dir):
    ...
    parser.add_argument(
        "--model_name", default="GAReader", type=str, help="name of the model"
    )
    ...
    parser.add_argument(
        "--output_dir",
        default=model_dir + "GAReader/",
        type=str,
        help="output path of the model",
    )
    parser.add_argument(
        "--log_dir",
        default=log_dir + "GAReader/",
        type=str,
        help="path of logging file",
    )

    parser.add_argument(
        "--do_train", default=True, action="store_true", help="Whether to run training."
    )
    ...
    parser.add_argument(
        ...
        default=200,
        type=int,
        help="save the model after how many steps",
    )
    ...
    parser.add_argument(
        ...
        default=128,
        type=int,
        help="the number of dimension of hidden size",
    )
    parser.add_argument(
        "--rnn_num_layers", default=1, type=int, help="number of RNN layer"
    )
    parser.add_argument("--bidirectional", default=True, type=bool)

    # GAReader
    parser.add_argument(
        "--ga_layers", default=1, type=int, help="the layer of GAReader"
    )
    ...
    parser.add_argument(
        "--glove_word_size", default=int(2.2e6), type=int, help="Corpus size for Glove"
    )
    parser.add_argument(
        "--glove_word_dim",
        default=300,
