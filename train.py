...
parser.add_argument('--model',type=str,action='store',help='The configuration for model',default='./configs/models/forty/default.yaml')
parser.add_argument('--train',type=str,action='store',help='The configuration for model training/evaluation',default='./configs/train.yaml')
parser.add_argument('--data',type=str,action='store',help='The configuration for data',default='./configs/datasets/forty/default.yaml')
...
preprocessor = configmapper.get_object("preprocessors", data_config.main.preprocessor.name)(data_config)
