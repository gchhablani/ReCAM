...
class ClozePreprocessor(Preprocessor):
    ...
    def preprocess(self, model_config, data_config):
        ...
        model = configmapper.get_object("models", model_config.name).from_pretrained(**model_config.params.as_dict())
...
class TransformersConcretenessPreprocessor(Preprocessor):
    ...
    def preprocess(self, model_config, data_config):
        ...
        model = configmapper.get_object("models", model_config.name)(**model_config.params.as_dict())
